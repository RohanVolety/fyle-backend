...
def test_get_assignments_in_various_states():
    ...
    # Print the expected and actual results for debugging
    # print("Expected Result:", expected_result)
    # print("SQL Result Before Modification:", sql_result)
    ...
    # expected_result = [('DRAFT', 2), ('GRADED', 5), ('SUBMITTED', 1)]
    ...
    # # Print the expected and actual results after modification for debugging
    # print("Expected Result After Modification:", expected_result)
    # print("SQL Result After Modification:", sql_result)
